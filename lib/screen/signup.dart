...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        padding: EdgeInsets.only(right: 40, left: 40, top: 20, bottom: 40),
          ...
          children: [
            VxCircle(
              ...
              backgroundImage: DecorationImage(
                image: (url == null || url!.isEmpty) // Check for null or empty string
                    ? NetworkImage(Images.sample_profile) as ImageProvider
                    : NetworkImage(url!),
                fit: BoxFit.fill,
              ),
            ),
